...
import { EyeIcon, EyeOff, UserIcon } from 'lucide-react'
        ...
        <div className='flex items-center justify-center w-full mt-15'>
            <div className='shadow-2xl w-[500px] h-[500px] rounded-3xl'>
                ...
                <div className='p-5'>
                    ...
                    <div className='p-3 rounded-2xl gap-2 flex items-center border-2 border-black w-full'>
                        <UserIcon/>
                ...
                <div className='p-5'>
                    ...
                    <div className='p-3 rounded-2xl gap-2 flex items-center border-2 border-black w-full'>
                        <UserIcon/>
                        <input type={Password ? 'text' : 'password'} className='outline-none w-full'/>
                        <button
                        type='button'
                        onClick={()=> setPassword(!Password)}
                        >
                            {Password ? <EyeOff/> : <EyeIcon/>}
                        </button>
                    </div>
                </div>
